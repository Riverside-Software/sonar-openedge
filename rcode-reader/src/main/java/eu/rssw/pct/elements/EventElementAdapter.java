...
public class EventElementAdapter extends TypeAdapter<IEventElement> {
  ...
  @Override
  public void write(JsonWriter out, IEventElement value) throws IOException {
    if (value == null) {
      out.nullValue();
      return;
    }
    ...
    out.name("delegateName").value(value.getDelegateName());
    out.name("returnType");
  ...
  @Override
  public IEventElement read(JsonReader in) throws IOException {
