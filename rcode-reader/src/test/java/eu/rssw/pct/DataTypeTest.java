...
public class DataTypeTest {
  ...
  public void testIsCompatible() {
    ...
    for (OpenEdgeVersion version : OpenEdgeVersion.values()) {
      assertTrue(new DataType("Progress.Lang.Object").isCompatible(new DataType("Progress.Lang.Enum"),
          VERSION_TYPE_INFO_PROVIDER.apply(version)));
      assertTrue(new DataType("Progress.Lang.Object").isCompatible(new DataType("Progress.BPM.BPMError"),
          VERSION_TYPE_INFO_PROVIDER.apply(version)));
      assertTrue(new DataType("Progress.Lang.SysError").isCompatible(new DataType("Progress.BPM.BPMError"),
          VERSION_TYPE_INFO_PROVIDER.apply(version)));
      assertTrue(new DataType("Progress.Lang.Error").isCompatible(new DataType("Progress.BPM.BPMError"),
          VERSION_TYPE_INFO_PROVIDER.apply(version)));
      assertFalse(new DataType("Progress.Lang.Enum").isCompatible(new DataType("Progress.Lang.Object"),
          VERSION_TYPE_INFO_PROVIDER.apply(version)));
    }
  }
}
