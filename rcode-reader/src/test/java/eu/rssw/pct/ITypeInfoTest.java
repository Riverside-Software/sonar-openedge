...
public class ITypeInfoTest {
  ...
  public void test05() {
    for (var version : OpenEdgeVersion.values()) {
      ...
      var sub4 = list2.stream().filter(
          it -> "Progress.Lang.Object".equalsIgnoreCase(it.getO1().getTypeName())).collect(Collectors.toList());
  ...
  public void test06() {
    for (var version : OpenEdgeVersion.values()) {
      ...
      assertEquals(sub3.get(0).getO2().getName(), "Next-Sibling");
      assertEquals(sub3.get(1).getO2().getName(), "Prev-Sibling");
      var sub4 = list.stream().filter(it -> "Progress.Lang.Error".equalsIgnoreCase(it.getO1().getTypeName())).collect(Collectors.toList());
      ...
      var sub8 = list2.stream().filter(it -> "Progress.Lang.Error".equalsIgnoreCase(it.getO1().getTypeName())).collect(Collectors.toList());
