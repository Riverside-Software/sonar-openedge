...
public class ITypeInfoTest {
  ...
  public void test01() {
    for (OpenEdgeVersion version : OpenEdgeVersion.values()) {
      var info = VERSION_TYPE_INFO_PROVIDER.apply(version).apply("Progress.BPM.UserSession");
      assertNotNull(info);
      assertNotNull(info.getMethod(VERSION_TYPE_INFO_PROVIDER.apply(version), "GetProcessTemplateNames",
          new DataType[] {}, new ParameterMode[] {}));
      assertNull(info.getMethod(VERSION_TYPE_INFO_PROVIDER.apply(version), "GetProcessTemplateNames",
          new DataType[] {DataType.INT64}, new ParameterMode[] {ParameterMode.INPUT}));
      assertNotNull(info.getMethod(VERSION_TYPE_INFO_PROVIDER.apply(version), "GetDataSlotTemplates",
          new DataType[] {DataType.CHARACTER}, new ParameterMode[] {ParameterMode.INPUT}));
      assertNotNull(info.getMethod(VERSION_TYPE_INFO_PROVIDER.apply(version), "StartProcess",
  ...
  public void test02() {
    for (OpenEdgeVersion version : OpenEdgeVersion.values()) {
      var info = VERSION_TYPE_INFO_PROVIDER.apply(version).apply("Progress.Json.ObjectModel.JsonArray");
      assertNotNull(info);
      assertNull(
          info.getMethod(VERSION_TYPE_INFO_PROVIDER.apply(version), "Add", new DataType[] {}, new ParameterMode[] {}));
      assertNotNull(info.getMethod(VERSION_TYPE_INFO_PROVIDER.apply(version), "Add",
          new DataType[] {DataType.CHARACTER}, new ParameterMode[] {ParameterMode.INPUT}));
      assertNotNull(info.getMethod(VERSION_TYPE_INFO_PROVIDER.apply(version), "Add", new DataType[] {DataType.LONGCHAR},
          new ParameterMode[] {ParameterMode.INPUT}));
      assertNotNull(info.getMethod(VERSION_TYPE_INFO_PROVIDER.apply(version), "Add",
          new DataType[] {new DataType("Progress.Json.ObjectModel.JsonArray")},
          new ParameterMode[] {ParameterMode.INPUT}));
      assertNull(info.getMethod(VERSION_TYPE_INFO_PROVIDER.apply(version), "Add",
          new DataType[] {new DataType("Progress.Lang.Object")}, new ParameterMode[] {ParameterMode.INPUT}));

      var val1 = info.getMethod(VERSION_TYPE_INFO_PROVIDER.apply(version), "GetDatetime",
      ...
      var methd01 = info.getMethod(VERSION_TYPE_INFO_PROVIDER.apply(version), "GetCharacter",
      ...
      var methd02 = info.getMethod(VERSION_TYPE_INFO_PROVIDER.apply(version), "GetCharacter",
          new DataType[] {DataType.INTEGER, DataType.INTEGER},
          new ParameterMode[] {ParameterMode.INPUT, ParameterMode.INPUT});
      assertNotNull(methd02);
      assertEquals(methd02.getO2().getExtent(), -1);

      var info2 = VERSION_TYPE_INFO_PROVIDER.apply(version).apply("Progress.Json.ObjectModel.JsonObject");
      var methd03 = info2.getMethod(VERSION_TYPE_INFO_PROVIDER.apply(version), "Write",
  ...
  public void test03() {
    for (OpenEdgeVersion version : OpenEdgeVersion.values()) {
      ITypeInfo info01 = VERSION_TYPE_INFO_PROVIDER.apply(version).apply("Progress.Lang.Object");
      ITypeInfo info02 = VERSION_TYPE_INFO_PROVIDER.apply(version).apply("Progress.Json.ObjectModel.JsonArray");
      assertNotNull(info01);
      assertNotNull(info02);
      assertNotNull(info01.getMethod(VERSION_TYPE_INFO_PROVIDER.apply(version), "ToString", new DataType[] {},
          new ParameterMode[] {}));
      assertNotNull(info02.getMethod(VERSION_TYPE_INFO_PROVIDER.apply(version), "ToString", new DataType[] {},
          new ParameterMode[] {}));
    }
  }
  ...
  public void test05() {
    for (OpenEdgeVersion version : OpenEdgeVersion.values()) {
      var info = VERSION_TYPE_INFO_PROVIDER.apply(version).apply("Progress.IO.FileInputStream");
      assertNotNull(info);

      var list = info.getAllProperties(VERSION_TYPE_INFO_PROVIDER.apply(version));
      ...
      var list2 = info.getAllMethods(VERSION_TYPE_INFO_PROVIDER.apply(version));
      ...
      var list3 = info.getAllConstructors(VERSION_TYPE_INFO_PROVIDER.apply(version));
  ...
  public void test06() {
    for (OpenEdgeVersion version : OpenEdgeVersion.values()) {
      var info = VERSION_TYPE_INFO_PROVIDER.apply(version).apply("Progress.Lang.AppError");
      assertNotNull(info);
  ...
  public void testUnknownDataType() {
    for (OpenEdgeVersion version : OpenEdgeVersion.values()) {
      var info = VERSION_TYPE_INFO_PROVIDER.apply(version).apply("Progress.Json.ObjectModel.JsonArray");
      assertNotNull(info);
      assertNull(info.getMethod(VERSION_TYPE_INFO_PROVIDER.apply(version), "Add", new DataType[] {DataType.UNKNOWN},
          new ParameterMode[] {ParameterMode.INPUT}));
      assertNotNull(info.getMethod(VERSION_TYPE_INFO_PROVIDER.apply(version), "Read", new DataType[] {DataType.UNKNOWN},
          new ParameterMode[] {ParameterMode.INPUT}));
    }
  }
