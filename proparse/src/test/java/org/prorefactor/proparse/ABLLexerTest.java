...
public class ABLLexerTest {
  ...
  public void testScientificNotation01() {
    ...
    var lexer = new ABLLexer(session, source.getBytes(), true);
  ...
  public void testSomeKeywords01() {
    final String source = "CURRENT-WINDOW:HANDLE. SESSION:FIRST-SERVER-SOCKET:HANDLE. TEMP-TABLE tt1::fld1. DATASET ds1::tt1. DATASET ds1::tt1:set-callback().";
    ABLLexer lexer = new ABLLexer(session, source.getBytes(), "file.txt");
  ...
  public void testAnalyzeSuspend() {
    try (InputStream input = new FileInputStream(new File("src/test/resources/data/lexer/lexer05.p"))) {
      ABLLexer lexer = new ABLLexer(session, input.readAllBytes(), "file.txt");
  ...
  public void testQuotedStringPosition01() {
    ...
    ABLLexer lexer = new ABLLexer(session, "do while xx > '': end.".getBytes(), "file.txt");
  ...
  public void testQuotedStringPosition03() {
    ABLLexer lexer = new ABLLexer(session, "\"Test\":L10.".getBytes(), "file.txt");
  ...
  public void testQuotedStringPosition04() {
    ABLLexer lexer = new ABLLexer(session, "\"Test\".".getBytes(), "file.txt");
  ...
  public void testQuotedStringPosition05() {
    ABLLexer lexer = new ABLLexer(session, "\"Test\":U.".getBytes(), "file.txt");
  ...
  public void testTypeName() {
    ABLLexer lexer = new ABLLexer(session, "CLASS Riverside.20190101.Object".getBytes(), "file.txt");
  ...
  public void testKeywords01() {
    ...
    ABLLexer lexer3 = new ABLLexer(session, "USERID USER-ID ".getBytes(), "file.txt");
  ...
  public void testAbbrevKeywords() {
    ABLLexer lexer = new ABLLexer(session, "LC('HELLO').".getBytes(), "file.txt");
    ProToken tok = (ProToken) lexer.nextToken();
    assertFalse(tok.isAbbreviated());

    lexer = new ABLLexer(session, "LOWER('WORLD').".getBytes(), "file.txt");
    tok = (ProToken) lexer.nextToken();
    assertFalse(tok.isAbbreviated());
    ...
    lexer = new ABLLexer(session, "SUBSTITUTE('').".getBytes(), "file.txt");
    tok = (ProToken) lexer.nextToken();
    assertFalse(tok.isAbbreviated());
  }
  ...
  public void testNestedComments() {
    ABLLexer lexer = new ABLLexer(session, "/* Gilles */ /* Gilles /* Querret */ Test */".getBytes(), "file.txt");
    ProToken tok = (ProToken) lexer.nextToken();
    assertNotNull(tok);
