...
public class BugFixTest extends AbstractProparseTest {
  ...
  @Test
  public void test51() {
    ParseUnit unit = genericTest("bug51.p");
    assertEquals(unit.getTopNode().queryStateHead().size(), 2);
  }

  @Test
  public void test52() {
    ParseUnit unit = genericTest("bug52.p");
    assertEquals(unit.getTopNode().queryStateHead().size(), 1);
  }
  ...
  public void testCreateComObject() {
    ...
    assertEquals(list.get(0).asIStatement().getNodeType(), ABLNodeType.CREATE);
