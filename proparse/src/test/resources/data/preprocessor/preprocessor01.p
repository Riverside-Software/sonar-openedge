...
&IF TRIM("ABC?", ",.;:!?") = "ABC" &THEN
 DEFINE VARIABLE var82 AS CHARACTER.
&ENDIF
&IF TRIM("???", ",.;:!?") = "" &THEN
 DEFINE VARIABLE var83 AS CHARACTER.
&ENDIF

&IF LOGICAL("yes") &THEN
  DEFINE VARIABLE var84 AS CHARACTER.
&ENDIF
&IF LOGICAL("no") &THEN
  DEFINE VARIABLE var85 AS CHARACTER.
&ENDIF
&IF LOGICAL("yes", "yes/no") &THEN
  DEFINE VARIABLE var86 AS CHARACTER.
&ENDIF
&IF LOGICAL("si", "si/no") &THEN
  DEFINE VARIABLE var87 AS CHARACTER.
&ENDIF
&IF LOGICAL("non", "oui/non") &THEN
  DEFINE VARIABLE var88 AS CHARACTER.
&ENDIF
&IF LOGICAL(0) &THEN
  DEFINE VARIABLE var89 AS CHARACTER.
&ENDIF
&IF LOGICAL(1) &THEN
  DEFINE VARIABLE var90 AS CHARACTER.
&ENDIF
&IF LOGICAL("xxxxxx") &THEN
  DEFINE VARIABLE var91 AS CHARACTER.
&ENDIF

&IF LOG(10) > 1 &THEN
  DEFINE VARIABLE var92 AS CHARACTER.
&ENDIF
&IF LOG(15) > 100 &THEN
  DEFINE VARIABLE var93 AS CHARACTER.
&ENDIF
