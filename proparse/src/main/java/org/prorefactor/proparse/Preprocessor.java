...
import static org.prorefactor.proparse.StringFuncs.escapeLineBreaks;
...
public class Preprocessor {
  ...
  private void newMacroRef(String macroName, FilePos refPos) throws IOException {
    if (listing) {
      StringBuilder bldr = new StringBuilder();
      bldr.append(refPos.file).append(" ").append(refPos.line).append(" ").append(refPos.col).append(" macroref ")
