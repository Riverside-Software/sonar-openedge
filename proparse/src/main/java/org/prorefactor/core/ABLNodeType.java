...
public enum ABLNodeType {
  ...
  CHARSET(ProParserTokenTypes.CHARSET, "charset", NodeTypesOption.KEYWORD),
  CHECK(ProParserTokenTypes.CHECK, "check", NodeTypesOption.KEYWORD, NodeTypesOption.RESERVED),
  CHECKED(ProParserTokenTypes.CHECKED, "checked", NodeTypesOption.KEYWORD),
  ...
  HIDDEN(ProParserTokenTypes.HIDDEN, "hidden", NodeTypesOption.KEYWORD),
  ...
  SCREENLINES(ProParserTokenTypes.SCREENLINES, "screen-lines", NodeTypesOption.KEYWORD, NodeTypesOption.RESERVED,
      NodeTypesOption.MAY_BE_NO_ARG_FUNC),
  SCREENVALUE(ProParserTokenTypes.SCREENVALUE, "screen-value", NodeTypesOption.KEYWORD),
  ...
  SENSITIVE(ProParserTokenTypes.SENSITIVE, "sensitive", NodeTypesOption.KEYWORD),
  ...
  VISIBLE(ProParserTokenTypes.VISIBLE, "visible", NodeTypesOption.KEYWORD),
